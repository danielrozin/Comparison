/**
 * H75 — Travel/booking, insurance, banking, smart home, more AI
 * Run: npx tsx scripts/gen-h75.ts
 */
...
const PAIRS: [string, string, string][] = [
  // Travel & booking
  ["Booking.com", "Expedia", "products"],
  ["Booking.com", "Hotels.com", "products"],
  ["Kayak", "Expedia", "products"],
  ["Trivago", "Booking.com", "products"],
  ["Priceline", "Expedia", "products"],
  ["Google Flights", "Kayak", "products"],
  ["Skyscanner", "Google Flights", "products"],
  // Insurance extended
  ["USAA", "Geico", "products"],
  ["Liberty Mutual", "Geico", "products"],
  ["Farmers Insurance", "State Farm", "products"],
  ["Lemonade", "State Farm", "products"],
  // Banking
  ["Chase", "Bank of America", "products"],
  ["Wells Fargo", "Chase", "products"],
  ["Capital One", "Chase", "products"],
  ["Ally Bank", "Marcus by Goldman Sachs", "products"],
  // More AI tools
  ["Cursor", "Aider", "technology"],
  ["Bolt.new", "v0 by Vercel", "technology"],
  ["Notion AI", "Coda AI", "technology"],
  ["Suno", "Udio", "technology"],
  // Smart home
  ["iRobot Roomba", "Eufy RoboVac", "products"],
  ["iRobot Roomba", "Shark IQ", "products"],
  ["Sonos", "Bose", "products"],
  ["Sonos Beam", "Bose Smart Soundbar", "products"],
  // Streaming devices
  ["Roku", "Amazon Fire TV", "products"],
  ["Apple TV 4K", "Roku Ultra", "products"],
];
...
async function main() {
  console.log(`H75: generating ${PAIRS.length} pairs...\n`);
  let ok = 0, fail = 0;
