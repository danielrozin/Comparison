...
// Count total pages above certain impressions thresholds to find rank 261-270
const total = await prisma.comparison.count({ where: { searchImpressions: { gt: 0 } } })
console.log(`Total pages with impressions: ${total}`)

// Get pages ordered by impressions desc to find ranks 261-270
...
console.log('\nPages ranked 261-270 by GSC impressions:')
let rank = 261
