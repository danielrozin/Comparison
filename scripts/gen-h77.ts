/**
 * H77 — Crypto, autos, real estate platforms, retail extended, home services
 * Run: npx tsx scripts/gen-h77.ts
 */
...
const PAIRS: [string, string, string][] = [
  // Crypto exchanges
  ["Coinbase", "Kraken", "products"],
  ["Coinbase", "Binance", "products"],
  ["Robinhood", "Coinbase", "products"],
  ["Gemini", "Coinbase", "products"],
  ["Crypto.com", "Coinbase", "products"],
  // Autos — specific models high traffic
  ["Tesla Model Y", "BMW iX", "automotive"],
  ["Tesla Model 3", "BMW i4", "automotive"],
  ["Tesla Model 3", "Polestar 2", "automotive"],
  ["Honda Civic", "Toyota Corolla", "automotive"],
  ["Toyota RAV4", "Honda CR-V", "automotive"],
  ["Mazda CX-5", "Honda CR-V", "automotive"],
  ["Subaru Outback", "Toyota RAV4", "automotive"],
  // Real estate platforms extended
  ["Opendoor", "Redfin", "products"],
  ["Compass", "Redfin", "products"],
  ["Rocket Mortgage", "Better.com", "products"],
  // Retail extended
  ["Walmart", "Amazon", "products"],
  ["Sephora", "Ulta", "products"],
  ["Lowe's", "Home Depot", "products"],
  ["Macy's", "Nordstrom", "products"],
  ["TJ Maxx", "Marshalls", "products"],
  // Home services
  ["TaskRabbit", "Thumbtack", "products"],
  ["Angi", "HomeAdvisor", "products"],
  ["Rover", "Wag", "products"],
  // Coffee & food
  ["Nespresso", "Keurig", "products"],
  ["Chipotle", "Qdoba", "products"],
];
...
async function main() {
  console.log(`H77: generating ${PAIRS.length} pairs...\n`);
  let ok = 0, fail = 0;
