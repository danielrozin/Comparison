/**
 * H79 — News/media, education tech, productivity, brands extended
 * Run: npx tsx scripts/gen-h79.ts
 */
...
const PAIRS: [string, string, string][] = [
  // News/Media
  ["The New York Times", "Washington Post", "products"],
  ["Bloomberg", "Reuters", "products"],
  ["CNN", "Fox News", "products"],
  ["The Wall Street Journal", "Bloomberg", "products"],
  ["Substack", "Medium", "technology"],
  // Education tech
  ["Khan Academy", "Quizlet", "technology"],
  ["Anki", "Quizlet", "technology"],
  ["Photomath", "Mathway", "technology"],
  ["Grammarly", "ProWritingAid", "technology"],
  // Productivity & to-do
  ["Todoist", "TickTick", "technology"],
  ["Things 3", "OmniFocus", "technology"],
  ["Bear", "Apple Notes", "technology"],
  ["Obsidian", "Logseq", "technology"],
  // Toys & lifestyle brands
  ["Lego", "Mega Bloks", "products"],
  ["Crocs", "Birkenstock", "products"],
  ["UGG", "Crocs", "products"],
  // Pets & home extended
  ["Chewy", "PetSmart", "products"],
  ["Litter Robot", "PetSafe ScoopFree", "products"],
  // Photography & content
  ["GoPro", "Insta360", "products"],
  ["Lightroom", "Capture One", "technology"],
  ["Final Cut Pro", "Premiere Pro", "technology"],
  ["DaVinci Resolve", "Premiere Pro", "technology"],
  // Streaming/audio specifics
  ["YouTube Music", "Spotify", "entertainment"],
  ["Tidal", "Spotify", "entertainment"],
  ["Pandora", "Spotify", "entertainment"],
];
...
async function main() {
  console.log(`H79: generating ${PAIRS.length} pairs...\n`);
  let ok = 0, fail = 0;
