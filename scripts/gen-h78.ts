/**
 * H78 — Credit cards, cruises, TVs, audio brands, kitchen, mattresses
 * Run: npx tsx scripts/gen-h78.ts
 */
...
const PAIRS: [string, string, string][] = [
  // Credit cards (specific cards — high search)
  ["Chase Sapphire Preferred", "Chase Sapphire Reserve", "products"],
  ["Chase Sapphire Reserve", "Amex Platinum", "products"],
  ["Capital One Venture X", "Chase Sapphire Reserve", "products"],
  ["Amex Gold", "Chase Sapphire Preferred", "products"],
  ["Amex Platinum", "Amex Gold", "products"],
  // Cruise lines
  ["Royal Caribbean", "Carnival", "products"],
  ["Norwegian Cruise Line", "Royal Caribbean", "products"],
  ["Disney Cruise Line", "Royal Caribbean", "products"],
  ["Princess Cruises", "Holland America", "products"],
  // TV brands
  ["Samsung QLED", "LG OLED", "technology"],
  ["LG OLED", "Sony OLED", "technology"],
  ["TCL", "Hisense", "technology"],
  ["Vizio", "TCL", "technology"],
  // Audio extended
  ["JBL", "Bose", "products"],
  ["Beats", "AirPods", "products"],
  ["Marshall", "JBL", "products"],
  ["Sonos Move", "JBL Charge", "products"],
  // Kitchen appliances
  ["Vitamix", "Ninja", "products"],
  ["KitchenAid", "Cuisinart", "products"],
  ["Instant Pot", "Ninja Foodi", "products"],
  ["Breville", "Cuisinart", "products"],
  // Mattresses
  ["Casper", "Saatva", "products"],
  ["Purple", "Tempur-Pedic", "products"],
  ["Tuft & Needle", "Casper", "products"],
  ["Nectar", "Purple", "products"],
];
...
async function main() {
  console.log(`H78: generating ${PAIRS.length} pairs...\n`);
  let ok = 0, fail = 0;
