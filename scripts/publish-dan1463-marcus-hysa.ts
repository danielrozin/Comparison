/**
 * DAN-1463: Publish Marcus HYSA blog post targeting "marcus hysa" (8,100/mo, pos 30)
 * Run: npx tsx scripts/publish-dan1463-marcus-hysa.ts
 */
...
const CONTENT = `# Marcus by Goldman Sachs HYSA Rate 2026: Current APY & Full Review

If you've been searching for a no-frills high-yield savings account, **Marcus by Goldman Sachs** is one of the most searched names in online banking. This guide covers everything you need to know about the Marcus HYSA — the current rate, how it works, who it's best for, and how it stacks up against top competitors like Ally Bank.
...
async function main() {
  ...
  const result = await prisma.blogArticle.upsert({
    ...
    create: {
      slug: SLUG,
      title: "Marcus by Goldman Sachs HYSA Rate 2026: Current APY & Full Review",
      excerpt:
        "Everything you need to know about the Marcus HYSA — current APY rate, how it compares to Ally Bank, who it's for, and how to open an account in 2026.",
      content: CONTENT,
      category: "business",
      tags: [
        "marcus hysa",
        "marcus goldman sachs hysa",
      ...
      metaTitle:
        "Marcus by Goldman Sachs HYSA Rate 2026: Current APY & Review",
      metaDescription:
        "Marcus HYSA rate 2026: Current APY, no fees, no minimum balance. See how Marcus by Goldman Sachs high yield savings compares to Ally Bank and top competitors.",
      relatedComparisonSlugs: ["ally-bank-vs-marcus-by-goldman-sachs"],
      status: "published",
  ...
  console.log(`✅ Published: /blog/${result.slug}`);
