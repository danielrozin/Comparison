/**
 * H72 — Streaming, messaging, browsers, cloud storage, office, gaming, learning
 * Run: npx tsx scripts/gen-h72.ts
 */
...
const PAIRS: [string, string, string][] = [
  // Streaming services
  ["Disney+", "HBO Max", "entertainment"],
  ["Disney+", "Netflix", "entertainment"],
  ["Paramount+", "Peacock", "entertainment"],
  ["Apple TV+", "Disney+", "entertainment"],
  ["Peacock", "Hulu", "entertainment"],
  // Messaging apps
  ["WhatsApp", "Signal", "technology"],
  ["WhatsApp", "Telegram", "technology"],
  ["Signal", "Telegram", "technology"],
  ["iMessage", "WhatsApp", "technology"],
  // Cloud storage
  ["Google Drive", "Dropbox", "technology"],
  ["OneDrive", "Google Drive", "technology"],
  ["iCloud", "Google Drive", "technology"],
  // Browsers
  ["Chrome", "Firefox", "technology"],
  ["Chrome", "Safari", "technology"],
  ["Edge", "Chrome", "technology"],
  // Office suites
  ["Google Workspace", "Microsoft 365", "technology"],
  ["Google Docs", "Microsoft Word", "technology"],
  ["Google Sheets", "Excel", "technology"],
  // Gaming platforms
  ["PlayStation 5", "Xbox Series X", "entertainment"],
  ["Nintendo Switch", "PlayStation 5", "entertainment"],
  // Learning platforms
  ["Duolingo", "Rosetta Stone", "technology"],
  ["Coursera", "Udemy", "technology"],
  // Health & wellness
  ["Calm", "Headspace", "technology"],
  ["MyFitnessPal", "Cronometer", "technology"],
  // Maps
  ["Google Maps", "Apple Maps", "technology"],
  ["Waze", "Google Maps", "technology"],
  // Mobile OS
  ["iOS", "Android", "technology"],
];
...
async function main() {
  console.log(`H72: generating ${PAIRS.length} pairs...\n`);
  let ok = 0, fail = 0;
