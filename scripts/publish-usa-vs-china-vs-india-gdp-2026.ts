 ...
 *
 * Figures: IMF World Economic Outlook (April 2026), World Bank ICP (2024
 * update) PPP factors, OECD Economic Outlook 117 (December 2025). All 2026
 * calendar-year projections. Pre-publish reverify completed 2026-06-25 per CMO
 * >2% rule (DAN-1173): all major metrics moved >2% vs Oct-2025 WEO basis —
 * figures updated throughout. Key drivers: USD appreciation vs INR (India
 * nominal GDP down ~9%); EUR and JPY appreciation (Germany/Japan overtook India
 * in nominal rank). India now 6th largest nominal, still 3rd by PPP.
 */
...
// Figures updated to IMF WEO April 2026 (pre-publish reverify 2026-06-25).
// DATE_MODIFIED bumped to publish date per pre-publish reverify gate.
const DATE_PUBLISHED = new Date().toISOString(); // frozen on first publish only
const DATE_MODIFIED = "2026-06-27T00:00:00Z";
...
const TLDR =
  "There is no single winner — it depends on how you measure. By nominal GDP the order is the United States ($32.4T), China ($20.9T), then a distant India ($4.2T). By purchasing-power-parity GDP the order flips: China is #1 at ~$43.5T, ahead of the US ($32.4T) and India ($19.1T). By per-capita GDP the US is on a different tier entirely — ~$96,100 versus China's $30,900 and India's $13,200 PPP. India is the fastest-growing of the three by a wide margin (6.5% in 2026 vs China's 4.4% and the US's 2.3%), though INR depreciation has pulled its nominal ranking to 6th globally — behind Germany ($5.5T) and Japan ($4.4T). Aggregate size and individual living standard are not the same story.";
...
const comparison: ComparisonPageData = {
  ...
  quickAnswer: {
    ...
    keyFact:
      "By nominal GDP the US leads ($32.4T vs China $20.9T vs India $4.2T); by PPP GDP China leads (~$43.5T vs US $32.4T vs India $19.1T); by per-capita PPP the US is far ahead (~$96,100 vs $30,900 vs $13,200).",
  },
  verdict:
    "There is no single winner — the right ranking depends on which question you are asking. By nominal GDP (market exchange rates) the United States is still #1 at about $32.4 trillion in 2026, roughly 1.55× China's $20.9 trillion and 7.7× India's $4.2 trillion; this is the right number for defense spending, international debt, and dollar-denominated share-of-global-economy framing. By purchasing-power-parity GDP the order flips: China has been the world's largest economy since 2014 and reaches about $43.5 trillion in 2026 — roughly 34% larger than the US — with India third at ~$19.1 trillion in PPP terms; in nominal terms India has slipped to 6th globally as INR depreciation put Germany (~$5.5T) and Japan (~$4.4T) ahead. PPP is the right metric for real output, consumption, and living-standard comparisons. By per-capita GDP the US is on a different tier from either: ~$96,100 versus China's $30,900 and India's $13,200 in PPP terms, so a top-3 aggregate economy can still have a median citizen whose material life resembles a mid-income country. On growth, India leads decisively — 6.5% in 2026 and ~6.5% through 2030, versus China's 4.4% (a long deceleration through its property correction, aging, and trade friction) and the US's 2.3% at trend. India is projected to surpass Japan and the UK in nominal terms by ~2028–2029, but does not pass China nominally before ~2050 on any realistic projection. Anyone who tells you the US is 'still #1' or that China 'already passed the US' is choosing the metric that fits the headline; both are true and neither is the whole story.",
  category: "countries",
  entities: [
    {
      id: USA,
      ...
      name: "United States",
      shortDesc:
        "The world's largest nominal economy (~$32.4T in 2026) and highest per-capita output, a services-and-IP economy running at trend growth.",
      imageUrl: null,
      entityType: "country",
      position: 1,
      pros: [
        "Largest nominal GDP — ~$32.4T in 2026, about 29% of world output and ~1.55× China",
        "Highest per-capita GDP by a wide margin — ~$96,100 nominal and PPP (PPP = nominal since the international dollar is benchmarked to the US)",
        "At the global frontier in services, finance, software, healthcare, and tradable IP — the world's largest IP exporter",
        "Share of world GDP — ~29% nominal, ~16% PPP in 2026",
        "Deep, liquid capital markets and reserve-currency status",
      ],
      cons: [
        "Slowest growth of the three — 2.3% in 2026, ~2.0% through 2030 (running at trend)",
        "No longer the largest by purchasing power — China's $43.5T PPP is ~34% larger",
    ...
    },
    {
      ...
      name: "China",
      shortDesc:
        "The world's largest economy by purchasing power (~$43.5T PPP) and largest manufacturer, now decelerating as services catch up.",
      imageUrl: null,
      entityType: "country",
      position: 2,
      pros: [
        "Largest economy by PPP — ~$43.5T in 2026, about 34% larger than the US in real-output terms",
        "World's largest manufacturer — ~29% of global manufacturing value-added, roughly the US and EU combined",
        "Second-largest nominal economy at ~$20.9T, and the largest exporter of physical goods",
        "Per-capita PPP (~$30,900) is more than double its nominal per-capita, reflecting lower local prices",
        "Mid-pace growth (4.4% in 2026) still well above the US, with services compounding faster than industry",
      ],
      cons: [
        "Per-capita nominal GDP (~$14,800) is ~6.5× below the US — a top-3 economy with mid-income median living standards",
    ...
    },
    {
      ...
      name: "India",
      shortDesc:
        "The fastest-growing major economy (6.5% in 2026), 6th-largest nominal and 3rd-largest PPP, services-led with a long agricultural tail.",
      imageUrl: null,
      entityType: "country",
      position: 3,
      pros: [
        "Fastest-growing major economy — 6.5% in 2026 and ~6.5% through 2030, the fastest G20 economy every year since 2022",
        "6th-largest nominal economy (~$4.2T) — behind Germany (~$5.5T), Japan (~$4.4T), and UK (~$4.3T); projected to surpass Japan and UK by ~2028–2029",
        "3rd-largest PPP economy (~$19.1T), about 59% the size of the US in PPP terms",
        "World's largest software-services exporter (TCS, Infosys, Wipro) and IT-BPM hub, with a fast-growing fintech sector",
        "Highest cumulative 5-yr real growth of the three — roughly 39% over 2022–2026 — with decades of services-mix upside",
      ],
      cons: [
        "Lowest per-capita GDP among the three — ~$2,900 nominal and ~$13,200 PPP, far below China and the US",
        "16% agriculture share of GDP with ~43% of the labor force still in farming",
        "Smallest of the three in nominal terms — ~7.7× behind the US and ~5.0× behind China",
  ...
  keyDifferences: [
    {
      ...
      entityAValue: "Largest by nominal GDP (~$32.4T) and per-capita; 2nd by PPP",
      entityBValue: "Largest by PPP GDP (~$43.5T); 2nd by nominal (~$20.9T)",
      values: [
        "Largest by nominal GDP (~$32.4T) and per-capita; 2nd by PPP",
        "Largest by PPP GDP (~$43.5T); 2nd by nominal (~$20.9T)",
        "6th by nominal (~$4.2T), 3rd by PPP (~$19.1T), and fastest-growing",
      ],
      winnerIndex: "tie",
    },
    {
      label: "Growth trajectory",
      entityAValue: "At trend — 2.3% in 2026, ~2.0% to 2030",
      entityBValue: "Decelerating — 4.4% in 2026, ~3.7% to 2030",
      values: [
        "At trend — 2.3% in 2026, ~2.0% to 2030",
        "Decelerating — 4.4% in 2026, ~3.7% to 2030",
        "Fastest — 6.5% in 2026, ~6.5% to 2030",
      ],
      winnerIndex: 2,
    },
    {
      label: "Per-capita living standard (PPP)",
      entityAValue: "~$96,100 — a different tier from either",
      entityBValue: "~$30,900 — about 3.1× below the US",
      values: [
        "~$96,100 — a different tier from either",
        "~$30,900 — about 3.1× below the US",
        "~$13,200 — about 7.3× below the US",
      ],
      winnerIndex: 0,
    },
  ],
  ...
  attributes: [
    attr("nominal-gdp", "Nominal GDP (2026, USD)", "Scale", "$32.4T", "$20.9T", "$4.2T"),
    attr("ppp-gdp", "PPP GDP (2026, intl. $)", "Scale", "$32.4T", "$43.5T", "$19.1T"),
    attr("nominal-rank", "Nominal GDP world rank", "Scale", "#1", "#2", "#6"),
    attr("ppp-rank", "PPP GDP world rank", "Scale", "#2", "#1", "#3"),
    attr("real-growth", "Real GDP growth (2026, YoY)", "Growth", "2.3%", "4.4%", "6.5%"),
    ...
    attr("cumulative-growth", "Cumulative real GDP growth (2022–2026)", "Growth", "11.2%", "24.4%", "~39%"),
    attr("proj-2030-nominal", "Projected 2030 nominal GDP", "Growth", "~$38.5T", "~$25.5T", "~$5.7T"),
    attr("population", "Population", "People", "337M", "1.41B", "1.45B"),
    attr("per-capita-nominal", "Per-capita nominal GDP", "People", "$96,100", "$14,800", "$2,900"),
    attr("per-capita-ppp", "Per-capita PPP GDP", "People", "$96,100", "$30,900", "$13,200"),
    ...
    attr("global-nominal-share", "Share of world nominal GDP (2026)", "Global", "~29%", "~18%", "~4%"),
    attr("global-ppp-share", "Share of world PPP GDP (2026)", "Global", "~16%", "~22%", "~10%"),
  ],
  ...
  faqs: [
    {
      ...
      answer:
        "By nominal GDP, the United States is the largest at ~$32.4 trillion, ahead of China at ~$20.9 trillion and India at ~$4.2 trillion (India ranks 6th globally in nominal terms). By PPP GDP, China is the largest at ~$43.5 trillion, ahead of the US ($32.4T) and India ($19.1T).",
    },
    {
      question: "Is China's economy bigger than the US in 2026?",
      answer:
        "By purchasing power parity, yes — China's $43.5T PPP GDP is about 34% larger than the US's $32.4T. By nominal GDP (market exchange rates), no — the US is about 1.55× larger than China.",
    },
    {
      question: "When will India pass China in GDP?",
      answer:
        "On consensus IMF projections through 2030, India does not pass China in nominal GDP this decade or the next. India would pass China nominally only if both (a) India sustained 7%+ real growth for several decades and (b) China grew below 3%. In 2026 India's nominal ranking slipped to 6th globally as INR depreciation put Germany (~$5.5T) and Japan (~$4.4T) ahead. The realistic near-term catch-up story is India surpassing Japan and the UK in nominal terms (projected ~2028–2029), not passing China.",
    },
    {
      question: "Why is per-capita GDP so much higher in the US?",
      answer:
        "The US has a small population (~337M) relative to a large economy ($32.4T), giving a per-capita GDP near $96,100. China (1.41B people) and India (1.45B people) divide their GDP across populations roughly 4× the size of the US, which is why per-capita GDP is $14,800 nominal (China) and $2,900 nominal (India) even though both are top-6 economies by nominal output.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "By nominal GDP, the three combined are about 51% of world output in 2026 — roughly 29% (US), 18% (China), and 4% (India). By PPP GDP, they are about 48% of world output — roughly 16% (US), 22% (China), and 10% (India). Either way, the three account for roughly half of global economic activity.",
    },
    {
  ...
  metadata: {
    ...
    metaDescription:
      "USA vs China vs India GDP compared for 2026 — nominal ($32.4T/$20.9T/$4.2T), PPP, growth, per-capita, and sector mix. See which economy leads by each measure.",
