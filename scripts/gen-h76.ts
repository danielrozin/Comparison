/**
 * H76 — Fashion, beverages, outdoor gear, education, gaming
 * Run: npx tsx scripts/gen-h76.ts
 */
...
const PAIRS: [string, string, string][] = [
  ...
  ["Lululemon", "Athleta", "products"],
  ["Patagonia", "The North Face", "products"],
  ["Under Armour", "Nike", "products"],
  ["Allbirds", "Nike", "products"],
  ["Hoka", "Brooks", "products"],
  ["Hoka", "On Cloud", "products"],
  ["New Balance", "Asics", "products"],
  // Beverages
  ["Coca-Cola", "Pepsi", "products"],
  ["Red Bull", "Monster Energy", "products"],
  ["Gatorade", "Powerade", "products"],
  ["LaCroix", "Bubly", "products"],
  ["Liquid Death", "LaCroix", "products"],
  ["Celsius", "Red Bull", "products"],
  // Outdoor gear
  ["Yeti", "Hydro Flask", "products"],
  ["Yeti", "Stanley", "products"],
  ["Stanley", "Owala", "products"],
  ["REI", "Patagonia", "products"],
  ["Coleman", "Yeti", "products"],
  // Education extended
  ["Harvard", "Stanford", "education"],
  ["MIT", "Caltech", "education"],
  ["Khan Academy", "Coursera", "technology"],
  ["Brilliant", "Khan Academy", "technology"],
  // Gaming extended
  ["Steam Deck", "ROG Ally", "entertainment"],
  ["Steam Deck", "Nintendo Switch", "entertainment"],
];
...
async function main() {
  console.log(`H76: generating ${PAIRS.length} pairs...\n`);
  let ok = 0, fail = 0;
