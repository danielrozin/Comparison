/**
 * H71 — Finance, dating, pharmacy, real estate comparisons
 * Run: npx tsx scripts/gen-h71.ts
 */
...
const PAIRS: [string, string, string][] = [
  ...
  ["PayPal", "Venmo", "products"],
  ["American Express", "Visa", "products"],
  ["American Express", "Mastercard", "products"],
  ["Robinhood", "Fidelity", "products"],
  ["Charles Schwab", "Fidelity", "products"],
  ["Venmo", "Cash App", "products"],
  ["Zelle", "Venmo", "products"],
  ["Tinder", "Bumble", "products"],
  ["Hinge", "Tinder", "products"],
  ["Hinge", "Bumble", "products"],
  ["Match.com", "eHarmony", "products"],
  ["CVS", "Walgreens", "products"],
  ["Zillow", "Redfin", "products"],
  ["Zillow", "Realtor.com", "products"],
  ["Redfin", "Realtor.com", "products"],
  ["Uber", "Lyft", "products"],
  ["DoorDash", "Instacart", "products"],
  ["Airbnb", "VRBO", "products"],
  ["Netflix", "Hulu", "entertainment"],
  ["Apple Music", "Spotify", "entertainment"],
];
  ...
  const prompt = `Generate a structured comparison between "${entityA}" and "${entityB}". Return ONLY valid JSON:
{
  ...
  "category": "${category}",
  "entities": [
    {"name": "${entityA}", "shortDesc": "one line", "entityType": "service", "pros": ["p1","p2","p3"], "cons": ["c1","c2"], "bestFor": "who"},
    {"name": "${entityB}", "shortDesc": "one line", "entityType": "service", "pros": ["p1","p2","p3"], "cons": ["c1","c2"], "bestFor": "who"}
  ],
...
async function main() {
  console.log(`H71: generating ${PAIRS.length} pairs...\n`);
  let ok = 0, fail = 0;
