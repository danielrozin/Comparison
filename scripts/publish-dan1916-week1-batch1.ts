/**
 * DAN-1916: Week 1 Blog Batch 1 — Fix Draft 4 citation + publish all 5 posts (Aug 4-10)
 * Run: DIRECT_URL="postgresql://..." npx tsx scripts/publish-dan1916-week1-batch1.ts
 */
import * as dotenv from "dotenv";
import * as path from "path";
dotenv.config({ path: path.resolve(__dirname, "../.env.local"), override: true });

// Derive DIRECT_URL from DATABASE_URL if not set (remove -pooler from hostname)
...
// Aug 4-8, 2026 — staggered publish dates within the sprint window
const AUG4 = new Date("2026-08-04T10:00:00Z");
const AUG5 = new Date("2026-08-05T10:00:00Z");
const AUG6 = new Date("2026-08-06T10:00:00Z");
const AUG7 = new Date("2026-08-07T10:00:00Z");
const AUG8 = new Date("2026-08-08T10:00:00Z");

const POSTS = [
  // ─────────────────────────────────────────────────────────────────────────
  // Draft 1: Is FreeCash Legit? (40,500/mo, KD 7)
  // Fix: Reddit r/beermoney labelled as "user community reports", not primary citation
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "consumer",
    tags: ["freecash", "rewards sites", "gpt sites", "earn money online", "trustpilot", "paypal"],
    metaTitle: "Is FreeCash Legit? Honest 2026 Review | aversusb.net",
    metaDescription:
      "FreeCash is legitimate and pays real money, but most users earn $1–$20/month. We break down how it works, the real complaints, and when it's worth your time.",
    relatedComparisonSlugs: [],
    sourceQuery: "is freecash legit",
    sourceImpressions: 40500,
    publishedAt: AUG4,
...
- r/beermoney user community reports (aggregated member experiences, not a primary citation): [reddit.com/r/beermoney](https://www.reddit.com/r/beermoney)
`,
  },

  // ─────────────────────────────────────────────────────────────────────────
  // Draft 2: What Is Annual Income? (33,100/mo, KD 0) — no fixes needed
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "finance",
    tags: ["annual income", "gross income", "net income", "taxes", "salary", "personal finance"],
    metaTitle: "What Is Annual Income? Definition & How to Calculate It | aversusb.net",
    metaDescription:
      "Annual income is your total earnings over 12 months—gross before deductions, net after. Learn how to calculate it for salary, hourly, and self-employed situations.",
    relatedComparisonSlugs: [],
    sourceQuery: "what is annual income",
...
`,
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Draft 3: Is Palm Oil Bad for You? (22,200/mo, KD 8)
  // Fix: Fattore E et al. year changed from 2015 → 2014 (print citation date)
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "health",
    tags: ["palm oil", "saturated fat", "heart health", "nutrition", "cooking oils", "RSPO"],
    metaTitle: "Is Palm Oil Bad for You? What the Research Says (2026) | aversusb.net",
    metaDescription:
      "Palm oil isn't categorically harmful, but its high saturated fat content warrants moderation. We break down the cardiovascular research, processing differences, and environmental concerns.",
    relatedComparisonSlugs: [],
    sourceQuery: "is palm oil bad for you",
    sourceImpressions: 22200,
    publishedAt: AUG6,
...
`,
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Draft 4: Are Peptides Safe? (22,200/mo, KD 11)
  // Fix: Citation mismatch resolved via option (b):
  //   Body text updated to reference the Gorouhi & Maibach 2009 IJCS review
  //   (the paper actually listed in Sources), removing the unsupported "2021 JCD" claim.
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "health",
    tags: ["peptides", "skincare", "collagen peptides", "injectable peptides", "cosmetic safety", "anti-aging"],
    metaTitle: "Are Peptides Safe? What Science Says About Topical, Oral & Injectable | aversusb.net",
    metaDescription:
      "Topical skincare peptides are generally safe. Injectable peptides carry more risk. We break down what the research says by peptide type, delivery method, and regulatory status.",
    relatedComparisonSlugs: [],
    sourceQuery: "are peptides safe",
    sourceImpressions: 22200,
    publishedAt: AUG7,
...
`,
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Draft 5: Is Temu Legit? (49,500/mo, KD 0)
  // Fix: "cybersecurity firm (Grizzly Research)" → "short-seller research firm (Grizzly Research)"
  // ─────────────────────────────────────────────────────────────────────────
  {
    slug: "is-temu-legit",
    title: "Is Temu Legit? What to Know Before You Order (2026)",
    excerpt:
      "Yes, Temu is a legitimate e-commerce marketplace—your order will arrive, you can return items within 90 days, and the company processes real refunds. However, being legit doesn't mean problem-free. Temu has documented issues with shipping times, product quality consistency, misleading listing photos, and data privacy practices that you should understand before placing an order.",
    category: "consumer",
    tags: ["temu", "online shopping", "e-commerce", "amazon", "shein", "consumer safety"],
    metaTitle: "Is Temu Legit? What to Know Before You Order (2026) | aversusb.net",
    metaDescription:
      "Temu is legitimate—your order will arrive and refunds are real—but product quality is inconsistent, shipping takes weeks, and data privacy concerns are unresolved. Here's what to know.",
...
For a full breakdown, see our [Amazon vs Temu comparison](/compare/amazon-vs-temu) and [Shein vs Temu comparison](/compare/shein-vs-temu).
...
async function main() {
  console.log("DAN-1916: Publishing Week 1 Batch 1 blog posts (Aug 4-10 sprint)\n");
  console.log("Fixes applied:");
  console.log("  [Draft 1] Reddit r/beermoney relabelled as user community reports");
  console.log("  [Draft 3] Fattore et al. year corrected: 2015 → 2014");
  console.log("  [Draft 4] Body text updated to reference Gorouhi 2009 IJCS (not unsupported 2021 JCD claim)");
  console.log("  [Draft 5] Grizzly Research: 'cybersecurity firm' → 'short-seller research firm'");
  console.log("");
