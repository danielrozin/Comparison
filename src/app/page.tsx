    ...
    <>
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-8 animate-fade-in" style={{ animationDelay: "0.5s" }}>
              {[
                ...
                <Link
                  key={example.href}
                  href={example.href}
                  className="px-4 py-2.5 sm:py-2 bg-white/10 hover:bg-white/20 active:scale-[0.98] rounded-full text-sm font-medium text-white/90 transition-all backdrop-blur-sm"
                >
                  {example.label}
                </Link>
              ))}
      ...
      <section className="bg-primary-600 text-white py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <Link
            href="/#search"
            className="inline-flex items-center justify-center gap-2 w-full sm:w-auto max-w-xs mx-auto sm:mx-0 px-6 py-3 sm:px-8 sm:py-4 bg-white text-primary-700 font-bold rounded-full hover:bg-primary-50 active:scale-[0.98] transition-all shadow-lg focus:outline-none focus:ring-2 focus:ring-white/50"
          >
            Start Comparing
