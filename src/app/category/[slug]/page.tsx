...
export async function generateMetadata({ params, searchParams }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    twitter: { card: "summary_large_image", images: [{ url: ogImage, alt: `${category.name} Comparisons on A Versus B` }] },
    other: {
          ...
          <div className="flex flex-col sm:flex-row sm:items-start gap-5 sm:gap-7">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                <Link href="/authors/daniel-rozin" rel="author" className="inline-flex items-center gap-1.5 min-h-11 sm:min-h-0 px-3 py-1.5 bg-white/10 hover:bg-white/15 border border-white/15 hover:border-white/30 rounded-full text-xs font-semibold text-white backdrop-blur-sm transition-all">
