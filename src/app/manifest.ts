...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    description:
      `The internet's most comprehensive comparison platform — ${CANONICAL_COMPARISON_COUNT_FALLBACK} side-by-side comparisons across technology, sports, countries, products, and more.`,
    start_url: "/",
    display: "standalone",
