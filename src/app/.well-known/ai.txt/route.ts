...
export async function GET() {
  ...
  const lines = [
    ...
    ...ua("NaverBot"),
    ...ua("BaiduSpider"),
    "# ---- Mid-2026 new model + agentic AI crawlers ----",
    "",
    ...ua("SonarBot"),
    ...ua("Perplexity-Sonar"),
    ...ua("Mistral-Crawler"),
    ...
    ...ua("MidJourney-Bot"),
    ...ua("StabilityBot"),
    ...ua("CopilotStudio-Bot"),
    "# ---- July 2026 — research AI, academic crawlers, agentic IDEs ----",
    "",
    ...ua("ConsensusCrawler"),
    ...ua("ConsensusBot"),
    ...ua("ElicitBot"),
    ...ua("SciteBot"),
    ...ua("ResearchRabbitBot"),
    ...ua("SemanticScholarBot"),
    ...ua("Jenni-Bot"),
    ...ua("Perplexity-Research"),
    ...ua("WindsurfBot"),
    ...ua("CursorBot"),
    ...ua("Grok-4"),
    ...ua("Claude-Sonnet"),
