...
export default async function StudiesIndexPage() {
  ...
  const faqMethodologyAnswer = `Each study is built from our internal database of structured head-to-head comparison pages. We count how many distinct published comparisons each brand, tool, or product appears in, and rank matchups by comparison centrality — the combined number of comparisons the two sides each appear in. All figures are counts of published comparison pages; we do not publish traffic or readership numbers.`;
