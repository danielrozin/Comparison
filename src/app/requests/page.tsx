...
const REQ_OG_IMAGE = `${SITE_URL}/api/og?title=${encodeURIComponent("Request a Comparison")}&type=home`;
const REQ_TODAY = new Date().toISOString().split("T")[0];

export const metadata: Metadata = {
  title: REQ_TITLE,
  description: REQ_DESC,
  alternates: { canonical: REQ_URL, languages: { "en": REQ_URL, "x-default": REQ_URL } },
  openGraph: {
    title: REQ_TITLE,
    description: REQ_DESC,
    url: REQ_URL,
    ...
    locale: "en_US",
    siteName: SITE_NAME,
    images: [{ url: REQ_OG_IMAGE, width: 1200, height: 630, alt: REQ_TITLE }],
  },
  twitter: {
  ...
  other: {
    ...
    "citation_online_date": REQ_TODAY,
    "DC.title": REQ_TITLE,
  ...
  "@graph": [
    {
      ...
      description: REQ_DESC,
      abstract: REQ_DESC,
      alternativeHeadline: `Suggest & Vote on New ${SITE_NAME} Comparisons`,
      url: REQ_URL,
      genre: "Community Tool",
      inLanguage: "en-US",
      isAccessibleForFree: true,
      conditionsOfAccess: "Free",
      creativeWorkStatus: "Published",
      datePublished: "2024-01-01",
      dateModified: REQ_TODAY,
      lastReviewed: REQ_TODAY,
      contentReferenceTime: REQ_TODAY,
      thumbnailUrl: REQ_OG_IMAGE,
      image: {
        "@type": "ImageObject",
        "@id": `${REQ_URL}#primaryImage`,
        url: REQ_OG_IMAGE,
        contentUrl: REQ_OG_IMAGE,
        width: 1200,
        height: 630,
        caption: REQ_TITLE,
      },
...
export default function RequestsPage() {
  ...
  <defs>
    <pattern id="grid-requests-hero" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
  ...
  <rect width="100%" height="100%" fill="url(#grid-requests-hero)"/>
</svg>
