...
const collectionPageSchema = {
  ...
  audience: { "@type": "Audience", audienceType: "Technology professionals comparing workspace apps" },
  accessMode: ["textual"],
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <nav className="mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2 text-sm text-text-secondary">
            ...
            <li>/</li>
            <li>
              <Link href="/alternatives/notion" className="hover:text-primary-600">
                Alternatives
              </Link>
            </li>
            <li>/</li>
            <li className="text-text font-medium">Notion Alternatives</li>
          </ol>
        </nav>
