...
const breadcrumbListSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: { "@type": "WebPage", "@id": PAGE_URL, name: "Slack Alternatives", url: PAGE_URL },
    },
  ],
};
...
const collectionPageSchema = {
  ...
  image: { "@type": "ImageObject", "@id": `${PAGE_URL}#primaryImage`, url: OG_IMAGE, contentUrl: OG_IMAGE, width: 1200, height: 630, caption: "Best Slack Alternatives in 2026 — A Versus B" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <nav className="mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center gap-1.5 text-sm text-text-secondary flex-wrap">
            ...
            <li>
              <Link href="/alternatives/slack" className="hover:text-primary-600 transition-colors">
                Alternatives
              </Link>
            </li>
            <li aria-hidden="true">
            ...
            <li className="text-text font-medium" aria-current="page">Slack Alternatives</li>
          </ol>
        </nav>
