  ...
  return (
    <>
      ...
      <section aria-labelledby="best-cloud-heading" className="bg-gradient-to-br from-slate-900 via-primary-900 to-cyan-900 text-white relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-72 h-72 bg-cyan-500/10 rounded-full blur-3xl -translate-y-1/3 translate-x-1/4 pointer-events-none" aria-hidden="true" />
