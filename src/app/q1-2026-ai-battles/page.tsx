...
export default function Q1AiBattlesPage() {
  ...
  <defs>
    <pattern id="grid-q1-2026-ai-battles-hero" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
  ...
  <rect width="100%" height="100%" fill="url(#grid-q1-2026-ai-battles-hero)"/>
</svg>
