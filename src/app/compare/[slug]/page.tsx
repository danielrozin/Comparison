...
import { TrackComparisonView } from "@/components/analytics/TrackComparisonView";
    ...
    <>
      ...
      {comparison.entities.length >= 2 && (
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <Accordion title="Who do you prefer? Cast your vote">
            <ComparisonPoll
      ...
      <div className="max-w-7xl mx-auto lg:flex lg:gap-8 lg:px-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Visual Comparison Charts — collapsed */}
          {comparison.attributes.some(a => a.values.some(v => v.valueNumber != null)) && (
            <Accordion title="Visual comparison charts">
              <ComparisonCharts
                attributes={comparison.attributes}
                entityA={comparison.entities[0]}
                entityB={comparison.entities[1]}
          ...
          {/* Resources & Learn More — collapsed */}
          <Accordion title="Resources & learn more">
            <ResourcesSection
      ...
      {/* Comments — collapsed */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <Accordion title="Comments & discussion">
