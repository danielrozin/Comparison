  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "FAQ", item: { "@type": "WebPage", "@id": `${SITE_URL}/faq`, name: "FAQ", url: `${SITE_URL}/faq` } },
      {
        ...
        position: 3,
        name: "G2 & Capterra",
        item: { "@type": "WebPage", "@id": PAGE_URL, name: "G2 & Capterra", url: PAGE_URL },
      },
    ],
  };
...
export default function G2ReviewsFaqPage() {
  ...
  <defs>
    <pattern id="grid-faq-g2-reviews-cta" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
  ...
  <rect width="100%" height="100%" fill="url(#grid-faq-g2-reviews-cta)"/>
</svg>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 relative">
          <nav className="mb-5" aria-label="Breadcrumb">
            <ol className="flex items-center gap-1.5 text-sm text-primary-200">
              ...
              <li className="text-white font-medium" aria-current="page">G2 &amp; Capterra</li>
            </ol>
          </nav>
      ...
      <section aria-labelledby="g2faq-key-differences-at-a" className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 id="g2faq-key-differences-at-a" className="text-2xl font-display font-bold text-text">Key Differences at a Glance</h2>
        </div>
        <div className="overflow-x-auto" tabIndex={0} role="region" aria-label="Comparison table — scroll to see all columns">
          <table className="w-full border border-border rounded-xl text-sm">
            <caption className="sr-only">Key differences at a glance — G2 / Capterra compared to aversusb</caption>
            <thead>
              <tr className="bg-surface-alt">
                <th scope="col" className="text-left p-4 font-semibold text-text border-b border-border">Feature</th>
                <th scope="col" className="text-left p-4 font-semibold text-text border-b border-border">G2 / Capterra</th>
      ...
      {/* FAQ Section */}
      <section id="faq-section" aria-labelledby="faq-heading" className="mb-16">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 id="faq-heading" className="text-2xl font-display font-bold text-text">Frequently Asked Questions</h2>
        </div>
  ...
  <defs>
    <pattern id="grid-faq-g2-reviews-hero" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
      <path d="M0 0h32v32" fill="none" stroke="#888" strokeWidth=".5" strokeOpacity=".4"/>
      <path d="M0 16h32M16 0v32" fill="none" stroke="#888" strokeWidth=".5" strokeOpacity=".2"/>
    </pattern>
  </defs>
  <rect width="100%" height="100%" fill="url(#grid-faq-g2-reviews-hero)"/>
</svg>
