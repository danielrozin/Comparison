...
export default function DiffenFaqPage() {
  ...
  <defs>
    <pattern id="grid-faq-diffen-cta" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
  ...
  <rect width="100%" height="100%" fill="url(#grid-faq-diffen-cta)"/>
</svg>
      ...
      <section aria-labelledby="diffenfaq-key-differences-at-a" className="mb-12">
        ...
        <div className="overflow-x-auto" tabIndex={0} role="region" aria-label="Comparison table — scroll to see all columns">
          <table className="w-full border border-border rounded-xl text-sm">
            <caption className="sr-only">Key differences at a glance — Diffen compared to aversusb</caption>
            <thead>
  ...
  <defs>
    <pattern id="grid-faq-diffen-hero" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
      <path d="M0 0h32v32" fill="none" stroke="#888" strokeWidth=".5" strokeOpacity=".4"/>
      <path d="M0 16h32M16 0v32" fill="none" stroke="#888" strokeWidth=".5" strokeOpacity=".2"/>
    </pattern>
  </defs>
  <rect width="100%" height="100%" fill="url(#grid-faq-diffen-hero)"/>
</svg>
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <NewsletterSignup source="faq-diffen" />
    </div>
    </>
  );
}
