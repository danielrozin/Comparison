...
const EMBED_OG_IMAGE = `${SITE_URL}/api/og?title=${encodeURIComponent("Embed Comparisons")}&type=home`;
const EMBED_TODAY = new Date().toISOString().split("T")[0];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "en_US",
    siteName: SITE_NAME,
    images: [{ url: EMBED_OG_IMAGE, width: 1200, height: 630, alt: EMBED_TITLE }],
  },
  twitter: {
  ...
  other: {
    ...
    "citation_online_date": EMBED_TODAY,
...
const embedSchema = {
  ...
  description: EMBED_DESC,
  abstract: EMBED_DESC,
  alternativeHeadline: `Free Embeddable Comparison Widgets for Blogs & Content Sites — ${SITE_NAME}`,
  url: EMBED_URL,
  ...
  dateModified: EMBED_TODAY,
  lastReviewed: EMBED_TODAY,
  contentReferenceTime: EMBED_TODAY,
  thumbnailUrl: EMBED_OG_IMAGE,
  image: {
    "@type": "ImageObject",
    "@id": `${EMBED_URL}#primaryImage`,
    url: EMBED_OG_IMAGE,
    contentUrl: EMBED_OG_IMAGE,
    width: 1200,
    height: 630,
    caption: EMBED_TITLE,
  },
...
const STEPS = [
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} aria-hidden="true">
