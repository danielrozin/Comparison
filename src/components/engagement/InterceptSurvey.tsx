      ...
      <div className="bg-surface border border-border shadow-2xl sm:rounded-xl rounded-t-xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-surface-alt">
          ...
          <button
            ...
            className="text-text-secondary hover:text-text transition-colors -mr-1 p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:rounded"
          >
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2.5 text-sm font-medium rounded-lg border border-border hover:border-primary-600 hover:bg-primary-50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1"
                  >
                    Yes
                  </button>
                  <button
                    ...
                    className={`flex-1 py-2.5 text-sm font-medium rounded-lg border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 ${
                ...
                {answers.q2Found === false && (
                  <div className="mt-3">
                    ...
                    <button
                      type="button"
                      onClick={advance}
                      className="mt-2 w-full py-2 text-sm font-semibold text-white bg-gradient-to-r from-primary-600 to-accent-600 hover:from-primary-700 hover:to-accent-700 rounded-lg hover:shadow-md transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
                    >
                      Continue
                    </button>
                  </div>
