      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="min-h-11 sm:min-h-0 text-sm px-3 py-1.5 bg-white border border-border rounded-lg text-text focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:border-primary-500"
          >
