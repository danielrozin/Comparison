    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        ...
        <select
          ...
          className="appearance-none min-h-11 sm:min-h-0 pl-3 pr-8 py-1.5 text-sm font-medium border border-border rounded-lg bg-white text-text hover:border-primary-300 focus:outline-none focus-visible:border-primary-400 focus-visible:ring-2 focus-visible:ring-primary-200 transition-colors cursor-pointer"
        >
          {SORT_OPTIONS.map((o) => (
