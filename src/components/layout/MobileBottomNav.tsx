    ...
    >
      <div className="grid grid-cols-4 h-14">
        ...
        >
          ...
          <span className={`text-[9px] font-semibold tracking-tight ${isHome ? "text-primary-600" : "text-text-secondary/60"}`}>Home</span>
        </Link>
        ...
        >
          ...
          <span className="text-[9px] font-semibold tracking-tight text-text-secondary/60">Search</span>
        </button>
        ...
        >
          ...
          <span className={`text-[9px] font-semibold tracking-tight ${isTrending ? "text-orange-500" : "text-text-secondary/60"}`}>Trending</span>
        </Link>
        ...
        >
          ...
          <span className={`text-[9px] font-semibold tracking-tight ${isBlog || isReviews ? "text-violet-600" : "text-text-secondary/60"}`}>Blog</span>
        </Link>
      </div>
    </nav>
  );
