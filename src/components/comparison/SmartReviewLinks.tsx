        ...
        {withReviews.map(({ name, slug, agg }) => {
          ...
          return (
            <li key={slug} role="group" aria-label={`Reviews for ${name}`} className="flex flex-col gap-2">
              ...
              <Link
                href={`/reviews/${slug}`}
                className="flex items-center gap-4 p-5 bg-white border border-border rounded-xl hover:border-primary-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group overflow-hidden relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 text-xs text-purple-600 hover:text-purple-700 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-1 rounded"
              >
