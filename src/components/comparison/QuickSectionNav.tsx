    ...
    >
      ...
      <div ref={scrollContainerRef} className="flex items-center gap-2 overflow-x-auto scrollbar-hide pb-1">
        ...
        {winnerName && (
          <>
            <span
              className="flex-shrink-0 inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold bg-amber-400/15 text-amber-700 border border-amber-300/50 whitespace-nowrap"
            >
        ...
        {visible.map((section) => {
          ...
          return (
            <a
              ...
              className={`flex-shrink-0 inline-flex items-center gap-1.5 min-h-11 sm:min-h-0 px-3.5 sm:px-3 py-1.5 rounded-full text-xs font-semibold border transition-all duration-150 whitespace-nowrap focus-visible:outline-2 focus-visible:outline-primary-500 focus-visible:outline-offset-2 ${
                isActive
