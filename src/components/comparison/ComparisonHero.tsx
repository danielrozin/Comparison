...
export function ComparisonHero({ comparison }: { comparison: ComparisonPageData }) {
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
      {/* Title */}
      <h1 className="text-2xl sm:text-4xl lg:text-5xl font-display font-black text-center text-text mb-2">
        {comparison.title}
      </h1>

      {/* Freshness metadata */}
      <div className="flex items-center justify-center gap-2 text-xs text-text-secondary mb-4 sm:mb-6">
        <span>
          Updated {new Date(comparison.metadata.updatedAt).toLocaleDateString("en-US", {
            year: "numeric",
            month: "short",
            day: "numeric",
          })}
