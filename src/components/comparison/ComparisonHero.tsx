...
function WinnerBadge() {
  return (
    ...
    >
      ...
      <span aria-hidden="true">Our Pick</span>
    </div>
  );
}
    ...
    <section aria-labelledby="comparison-hero-heading" className="relative bg-gradient-to-br from-primary-900 via-primary-800 to-indigo-900 text-white overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-16 sm:pb-20">
        ...
        {(comparison.verdict || comparison.quickAnswer?.tldr || comparison.shortAnswer) && (
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mt-5 motion-safe:animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <a
              href="#verdict"
              className="inline-flex flex-shrink-0 items-center gap-2 min-h-11 sm:min-h-0 px-5 py-2 rounded-full text-sm font-semibold whitespace-nowrap text-white/80 bg-white/15 hover:bg-white/25 border border-white/20 hover:border-white/40 backdrop-blur-sm transition-all duration-200 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60 focus-visible:ring-offset-2 focus-visible:ring-offset-primary-900"
            >
            ...
            <a
              ...
              className="inline-flex flex-shrink-0 items-center gap-2 min-h-11 sm:min-h-0 px-4 py-2 rounded-full text-xs font-semibold whitespace-nowrap text-white/80 hover:text-white border border-white/20 hover:border-white/40 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60 focus-visible:ring-offset-2 focus-visible:ring-offset-primary-900"
            >
              See differences
            </a>
            <HeroShareButton />
