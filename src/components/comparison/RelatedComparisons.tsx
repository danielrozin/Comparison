        ...
        {comparisons.map((comp, cardIdx) => {
          ...
          return (
            ...
            <Link
              ...
              className="group relative flex flex-col gap-3 p-4 pt-5 bg-white border border-border rounded-2xl hover:border-primary-200 hover:shadow-md motion-safe:hover:-translate-y-0.5 motion-safe:hover:scale-[1.02] transition-all duration-200 overflow-hidden motion-safe:animate-fade-in w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
            >
