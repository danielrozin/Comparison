            ...
            {currentCategory && (
              <li>
                <Link
                  ...
                  className="group flex items-center justify-between gap-2 min-h-11 sm:min-h-0 py-1 rounded-lg hover:bg-primary-50/50 px-1 -mx-1 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1"
                >
            ...
            {relatedCats.map((cat) => (
              <li key={cat.slug}>
                <Link
                  ...
                  className="group flex items-center justify-between gap-2 text-sm text-text-secondary hover:text-primary-600 min-h-11 sm:min-h-0 py-1 rounded-lg hover:bg-primary-50/50 px-1 -mx-1 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1"
                >
