  ...
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center gap-3 mb-5">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-slate-500 to-slate-700 flex items-center justify-center shadow-sm flex-shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
        {/* Entity links */}
        {entities.length > 0 && (
          <div className="bg-white border border-border rounded-2xl p-4 sm:p-5 hover:shadow-sm transition-shadow">
            <CardHeader
              ...
              {entities.map((entity) => (
                <li key={entity.slug}>
                  ...
                  >
                    ...
                    <svg className="w-3.5 h-3.5 text-text-secondary/40 group-hover:text-primary-500 group-hover:translate-x-0.5 transition-all flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {currentCategory && (
              <li>
                ...
                >
                  ...
                  <svg className="w-3.5 h-3.5 text-primary-400 group-hover:translate-x-0.5 transition-transform flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </Link>
              </li>
            ...
            {relatedCats.map((cat) => (
              <li key={cat.slug}>
                ...
                >
                  ...
                  <svg className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </Link>
              </li>
