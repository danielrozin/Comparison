      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ol className="flex items-center gap-1.5 text-xs sm:text-sm overflow-x-auto scrollbar-none whitespace-nowrap py-2.5 [-webkit-overflow-scrolling:touch] [mask-image:linear-gradient(to_right,transparent_0,black_16px,black_calc(100%-32px),transparent_100%)]">
          <li>
            <Link
              href="/"
              className="flex items-center gap-1.5 min-h-11 -my-2 px-1 text-text-secondary hover:text-primary-600 transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 rounded"
              aria-label="Home"
            >
            ...
            <>
              ...
              <li>
                <Link
                  ...
                  className="inline-flex items-center min-h-11 -my-2 px-1 text-text-secondary hover:text-primary-600 transition-colors font-medium capitalize focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 rounded"
                >
                  {category}
                </Link>
              </li>
            ...
            <>
              ...
              <li>
                <Link
                  ...
                  className="inline-flex items-center min-h-11 -my-2 px-1 text-text-secondary hover:text-primary-600 transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 rounded"
                >
                  {subcat.name}
                </Link>
              </li>
