    ...
    <div className="mt-5 pt-4 border-t border-white/10">
      ...
      <div className="flex items-center justify-center gap-2 flex-wrap">
        ...
        <button
          ...
          className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold border transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/70 ${
            copied
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold border bg-white/8 border-white/15 text-white/60 hover:bg-white/15 hover:text-white hover:border-white/30 transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/70"
        >
