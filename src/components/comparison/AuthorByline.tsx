    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <Link
          ...
          className="flex-shrink-0 inline-flex items-center justify-center min-w-11 min-h-11 sm:min-w-0 sm:min-h-0 -m-1 sm:m-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 rounded-full"
        >
        ...
        <div className="flex flex-col gap-0.5 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <Link
              href="/authors/daniel-rozin"
              rel="author"
              className="inline-flex items-center min-h-11 sm:min-h-0 text-sm font-semibold text-text hover:text-primary-700 transition-colors leading-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 rounded"
            >
              Daniel Rozin
            </Link>
