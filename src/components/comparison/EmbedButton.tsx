  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 min-h-[44px] text-sm font-medium text-text-secondary bg-surface-alt hover:bg-primary-50 hover:text-primary-600 border border-border rounded-lg transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
        ...
        >
          ...
          <div ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="embed-modal-title" className="relative bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto border border-border">
            ...
            <button
              ...
              className="absolute top-4 right-4 w-11 h-11 flex items-center justify-center rounded-full text-text-secondary hover:text-text hover:bg-surface-alt transition-colors z-10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
            >
              ...
              <div role="tablist" aria-label="Embed type" className="flex gap-1 bg-surface-alt rounded-lg p-1">
                {embedTabOrder.map((tab, i) => (
                  <button
                    ...
                    className={`flex-1 text-sm font-medium py-2 px-3 rounded-md transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 ${
                      activeTab === tab
            ...
            <div id={`embed-panel-${activeTab}`} role="tabpanel" aria-labelledby={`embed-tab-${activeTab}`} className="px-6 py-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`absolute top-2 right-2 px-3 py-1.5 text-xs font-medium rounded-lg transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 ${
                    copiedTab === activeTab
