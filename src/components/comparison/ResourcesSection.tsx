            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 list-none">
              {wikipedia.map((r) => (
                ...
                >
                  ...
                  <svg className="w-4 h-4 text-blue-200 group-hover:text-blue-400 flex-shrink-0 ml-auto mt-0.5 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 list-none">
              {videos.map((r) => (
                ...
                >
                  ...
                  <svg className="w-4 h-4 text-red-200 group-hover:text-red-400 flex-shrink-0 ml-auto mt-0.5 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
                </li>
