    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-1.5 mt-0.5">
          {comp.category && (
            <span className="inline-block text-xs font-medium px-1.5 py-0.5 rounded-md bg-border/60 text-text-secondary capitalize">
              {comp.category}
            </span>
          )}
          {isTrending && (
            <span className="inline-flex items-center gap-0.5 text-xs font-bold px-1.5 py-0.5 rounded-md bg-orange-50 text-orange-600 border border-orange-100">
