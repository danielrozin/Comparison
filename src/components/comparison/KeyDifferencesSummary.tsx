      ...
      <div className="relative bg-gradient-to-br from-indigo-50 via-white to-purple-50 border border-indigo-100 rounded-xl p-4 sm:p-5 overflow-hidden">
        ...
        {differences.length > 3 && (
          <a
            ...
            className="inline-flex items-center gap-1 min-h-11 sm:min-h-0 mt-3 text-sm font-medium text-indigo-600 hover:text-indigo-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:rounded"
          >
