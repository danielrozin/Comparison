        ...
        {searches.slice(0, 9).map((search) => {
          ...
          return (
            <Link
              ...
              className="group flex items-center gap-3 p-4 bg-white border border-border rounded-xl hover:border-primary-300 hover:shadow-md motion-safe:hover:-translate-y-0.5 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
            >
              ...
              <div aria-hidden="true" className="relative flex-shrink-0 h-10" style={{ width: "54px" }}>
                ...
                <div className="absolute left-4 top-0 w-9 h-9 bg-gradient-to-br from-accent-400 to-accent-600 rounded-full flex items-center justify-center text-xs font-bold text-white ring-2 ring-white shadow-sm z-0">
          ...
          <div className="flex flex-wrap gap-2">
            {getUniqueTags(searches).slice(0, 15).map((tag, i) => (
              <Link
                ...
                className={`px-3 py-1 text-xs font-medium rounded-full transition-all motion-safe:hover:-translate-y-0.5 capitalize focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 ${
                  i < 3
