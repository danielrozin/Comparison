      ...
      <div className="p-4 sm:p-5 flex flex-col flex-1">
        ...
        {!isTopThree && (
          <div className="overflow-hidden max-h-0 group-hover:max-h-8 transition-all duration-200 mt-0 group-hover:mt-2">
            <div className="flex items-center justify-center gap-1 text-[11px] font-semibold text-white bg-gradient-to-r from-primary-600 to-accent-600 rounded-lg py-1.5">
              View Comparison
