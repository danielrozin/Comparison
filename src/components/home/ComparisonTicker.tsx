            ...
            {doubled.map((item, idx) => {
              ...
              return (
                <Link
                  ...
                  className="inline-flex items-center gap-2 min-h-11 px-4 py-2.5 text-xs font-medium text-text hover:text-primary-700 group transition-colors duration-150 border-r border-border/40 last:border-r-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary-500"
