        ...
        {items.map((item, idx) => {
          ...
          return (
            ...
            >
              ...
              {isTop && (
                <div className="absolute top-3 right-3 flex items-center gap-1 bg-gradient-to-r from-amber-400 to-orange-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-sm shadow-amber-300/40 z-10">
              ...
              <div className="p-5 flex flex-col flex-1">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {item.categories?.[0] && (
                      <span className="inline-block mt-1 text-xs font-semibold px-2 py-0.5 rounded-full bg-primary-50 text-primary-600 capitalize">
                        {item.categories[0]}
                      </span>
                    )}
                  </div>
