        ...
        {items.slice(0, 8).map((item) => {
          ...
          return (
            <Link
              ...
              className="group flex items-center gap-3 p-3 bg-white border border-border rounded-xl hover:border-primary-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 min-w-[260px] sm:min-w-0 sm:flex-1 sm:basis-[calc(33.333%-0.75rem)] sm:max-w-[calc(33.333%-0.5rem)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
            >
