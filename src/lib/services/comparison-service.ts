...
function transformToPageData(
  ...
  return {
    ...
    metadata: {
      ...
      // DAN-1152 Bug 3: when the DB has no explicit metaDescription, derive it
      // from shortAnswer through clampDescription (word boundary + "…") rather
      // than a raw mid-word slice(0,155) that bypasses the clamp.
      metaDescription:
