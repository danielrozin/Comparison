/**
 * Body for /best/cloud-platforms-2026.
 *
 * Mirrors the rev-3 draft from DAN-426 (also published to
 * /blog/best-cloud-platforms-2026 via DAN-827 as the interim Path A).
 * Source-of-truth markdown lives at scripts/data/best-cloud-platforms-2026.md.
 * Backticks in the rendered table cell are escaped because this is a TS
 * template literal.
 */

export const CLOUD_PLATFORMS_2026_BODY = `*By [the CEO](/authors/daniel-rozin) — Editorial author of record. Last updated 2026-05-13. [How we ranked these clouds →](/best/cloud-platforms-2026/methodology)*
