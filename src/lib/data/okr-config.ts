/**
 * OKR Configuration — Company & Team OKRs
 *
...
export interface OKR {
  ...
  overallProgress: number; // 0-100, avg of key results
}
...
export const okrConfig: OKRConfig = {
  ...
  healthMetrics: [
    ...
    },
    {
      ...
      status: "red",
      detail: "Low returning user rate (~5%); bounce rate high (~72%); GA4 data still accumulating",
      lastUpdated: "2026-04-06",
    },
  ],
};
